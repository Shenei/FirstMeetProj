...
//数量增减事件
const vkOnChange = (e: InputNumberBoxEvent) => {
...
<template>
  <scroll-view scroll-y class="scroll-view" @scrolltolower="onScrolltolower">
    ...
    <template v-if="memberStore.profile">
          ...
          <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
            ...
            <view class="goods">
              ...
              <text
                ...
                @tap="($event) => onSelectedChange(item)"
              ></text>
              <navigator
      ...
      <view
        class="toolbar"
        :style="{ paddingBottom: fromGoods ? safeAreaInsets?.bottom + 'px' : 0 }"
      >
    ...
    <!-- 未登录: 提示登录 -->
    <view class="login-blank" v-if="noLogin">
