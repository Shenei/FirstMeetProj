...
import type { GuessLikeInstance } from '@/types/component'
...
//每次调用这个封装后的函数就会返回一个ref实例一个触底加载函数
...
<template>
  <scroll-view class="viewport" scroll-y enable-back-to-top @scrolltolower="onScrolltolower">
    ...
    <view class="profile" :style="{ paddingTop: safeAreaInsets!.top + 'px' }">
      ...
      <view class="overview" v-if="memberStore.profile?.token">
        ...
        <view class="meta">
          ...
          <navigator class="extra" url="/pagesMember/profile/profile" hover-class="none">
            <text class="update" @tap="updateInfo">更新头像昵称</text>
          </navigator>
        </view>
      </view>
      <!-- 情况2：未登录 -->
      ...
      <navigator class="settings" url="/pagesMember/userSetting/userSetting" hover-class="none">
        设置
      </navigator>
    </view>
    <!-- 我的订单 -->
