...
//获取物流信息
const getDeliverDes = async () => {
  //2025接口500
  const res = await getMemberOrderLogisticsByIdAPI(query.id)
  logistcList.value = res.result.list
    ...
    <template v-if="order">
      ...
      <view class="overview" :style="{ paddingTop: safeAreaInsets!.top + 20 + 'px' }">
        ...
        <template v-else>
          ...
          <view class="button-group">
            ...
            <view v-if="order?.orderState === OrderState.DaiFaHuo" class="button" @tap="onDelivery">
              模拟发货
            </view>
            <view
      ...
      <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
        ...
        <template v-else>
          ...
          <view class="button delete" v-if="order!.orderState >= OrderState.DaiPingJia" @tap="deleteOrder">
            删除订单
          </view>
        </template>
      </view>
